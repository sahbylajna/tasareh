...
class DataBackupCompletedPage extends AnimatedWidget {
  DataBackupCompletedPage({required Animation<double> endingAnimation}) : super(listenable: endingAnimation);
                ...
                children: [
                  ...
                  Expanded(
                    child: TweenAnimationBuilder(
                      ...
                      child: Column(
                        children: [
                          Text('data has succesfully\nuploaded', style: TextStyle(fontSize: 17), textAlign: TextAlign.center),
                          Spacer(),
                          OutlinedButton(
                            onPressed: null,
                            child: Padding(
