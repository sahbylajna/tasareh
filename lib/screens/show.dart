...
//             }
//   try {
//     OpenFile.open('/data/user/0/com.tasareeh.tasareeh/app_flutter/test2.pdf');
//     final response = await dio.get(fileUrl, options: Options(responseType: ResponseType.bytes));

//     final directory = await getApplicationDocumentsDirectory();
//     print(directory);

//     final filePath = '/data/user/0/com.tasareeh.tasareeh/$fileName';
        ...
        child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                ...
                onPressed: () => Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => BookContent()), (route) => false),
              ),
